...
function BigWigsLoD:ZONE_CHANGED_NEW_AREA()
	...
	if GetZoneText() == BZ["Alterac Valley"] and not BigWigs:IsModuleActive("Alterac Valley", "Alterac Valley") then
		BigWigs:EnableModule("Alterac Valley", "Alterac Valley")
		bwAvReboot = true
	end
	
	if GetZoneText() == BZ["Alterac Valley"] and BigWigs:IsModuleActive("Alterac Valley", "Alterac Valley") and bwAvReboot == true then
...
function BigWigsLoD:MINIMAP_ZONE_CHANGED()
	if GetZoneText() == BZ["Alterac Valley"] then
